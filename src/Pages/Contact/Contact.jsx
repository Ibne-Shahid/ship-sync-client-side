                                                ...
                                                <div className="form-control">
                                                    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                                                        <label className="flex items-center cursor-pointer gap-3">
                                                            <input type="checkbox" className="checkbox checkbox-accent shrink-0" required />
                                                            <span className="font-semibold text-base-content sm:hidden">
                                                                Agreement:
                                                            </span>
                                                        </label>
                                                        <span className="text-sm sm:text-base text-base-content pl-9 sm:pl-0 break-words">

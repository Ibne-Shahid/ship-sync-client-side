...
const Footer = () => {
    return (
        <footer className="footer footer-horizontal footer-center bg-blue-300 text-base-content rounded p-10">
            ...
            <aside>
                <p>Copyright © {new Date().getFullYear()} - All right reserved by ShipSync.</p>
            </aside>
        </footer>
    )
}
